...
public class Doctor extends Human {
    ...
    public Doctor () {
        ...
        this.level = random.nextInt(LEVEL_MAX);
        soutStatus("created: " + this.toString());
    }
    ...
    public boolean heal (Human human) {
        ...
        soutStatus("have heal " + human.getName() +".");
        if (human != this)
            return !trySelfDamage();
        return true;
    }
    ...
    private boolean trySelfDamage() {
        ...
        soutStatus("have done operation successful.");
        return damaged;
    }
    ...
    private void soutDiagnose(Human human, String diagnose) {
        System.out.print(getName()+" diagnose: ");
